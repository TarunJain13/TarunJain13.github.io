...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://cases.iima.ac.in/index.php/learning-from-edtech.html"
         target="_blank"
    ...
    <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>IIM Ahmedabad Case</strong> <em>IIMA/RJMC0048</em>, with Ambrish Dongre.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://cases.iima.ac.in/index.php/fee-regulation-in-private-schooling-the-case-of-gujarat.html"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://cases.iima.ac.in/index.php/deworming.html"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
        Deworming
      </a>
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>IIM Ahmedabad Case</strong> <em>IIMA/CMHS0046TEC</em>, with Pallavi Wats.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://cases.iima.ac.in/index.php/malaria-eradication.html"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
        Malaria eradication
      </a>
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>IIM Ahmedabad Case</strong> <em>IIMA/CMHS0045TEC</em>, with Pallavi Wats.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://hbsp.harvard.edu/product/ISB096-PDF-ENG"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
       Teacher incentives
</a>
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>Harvard Business Case</strong> <em>ISB096-PDF-ENG</em>, with Kalyani Chaudhuri.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://hbsp.harvard.edu/product/ISB059-PDF-ENG"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>Harvard Business Case</strong> <em>ISB059-PDF-ENG</em>, with Rohini Ray.
    </p>
...
Course allocation methods 
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>Harvard Business Case</strong> <em>ISB033-PDF-ENG</em>, with Priyanka Sarda.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin-top:36px;">
  ...
  <div style="flex:1;">
    ...
    <h3 style="margin:0 0 10px 0;">
      <a href="https://hbsp.harvard.edu/product/ISB032-PDF-ENG"
         target="_blank"
         style="color:#9b0f2f; text-decoration:underline;">
A class divided
</a>
 ...
 <p style="margin:0 0 12px 0; font-size:1.05rem;">
      <strong>Harvard Business Case</strong> <em>ISB032-PDF-ENG</em>.
    </p>
